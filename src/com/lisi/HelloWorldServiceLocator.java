...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.lisi.HelloWorldService {
    ...
    public com.lisi.HelloWorld_PortType getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.lisi.HelloWorldSoapBindingStub _stub = new com.lisi.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.lisi.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.lisi.HelloWorldSoapBindingStub _stub = new com.lisi.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
